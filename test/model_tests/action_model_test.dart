...
void main() {
  group('from json', () {
    ...
    test('CauseAction serializes successfully', () async {
      ...
      expect(action.releasedAt, DateTime.utc(2021, 4, 30, 23, 0, 0));
      expect(action.whatDescription,
          "Become a friend of the free press and make a donation starting at 5€.");
      expect(action.whyDescription,
          "Your contribution will help provide the support to journalists in need, helping media in conflict areas, and develop techniques to circumvent censorship and protect sources. By becoming a friend, you will also receive priority invitations to debates, workshops, festivals and film evenings, as well as updates how this organisation spends your donation.");
