...
void main() {
  group('Campaign', () {
    test('ListCampaign fromJson serializes correctly', () async {
      ...
      expect(campaign.headerImage, "https://images.unsplash.com/photo-1437914983566-976d85602771?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80");
	...
	test('Campaign fromJson serializes correctly', () async {
	  ...
	  expect(campaign.infographicUrl, "https://now-u.s3.eu-west-2.amazonaws.com/blm_campaign_illustration_f5ede3b48c.png");
    });
  });
}
