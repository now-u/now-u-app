...
final List<Badge> badges = [
  ...
  Badge(
    ...
    points: 100,
    successMessage: "Nice work! You took the next step with now-u and are making a real difference. Lets do this!"
  ),
  Badge(
    name: "now-u high-flyer",
    image: "assets/imgs/badges/achievement badges-03.png",
    points: 200,
    successMessage: "Good stuff! You're finding your groove and gaining momentum!  Keep going!"
  ),
  Badge(
    name: "now-u star",
    image: "assets/imgs/badges/achievement badges-04.png",
    points: 350,
    successMessage: "Awesome work! Feels good to do good, right? Stay positive!"
  ),
  Badge(
    name: "now-u superstar",
    image: "assets/imgs/badges/achievement badges-05.png",
    points: 500,
    successMessage: "Well done! The time is now - simple steps, real progress! Don't stop!"
  ),
  Badge(
    name: "now-u champion",
    image: "assets/imgs/badges/achievement badges-06.png",
    points: 750,
    successMessage: "Great job! Your efforts are paying off together we can do this!"
  ),
  Badge(
    name: "now-u hero",
    image: "assets/imgs/badges/achievement badges-07.png",
    points: 1000,
    successMessage: "Amazing work! You are really playing your part as an active global citizen!"
  ),
  Badge(
    name: "now-u superhero",
    image: "assets/imgs/badges/achievement badges-08.png",
    points: 1250,
    successMessage: "Another win! Progress is made with each action you take! Keep it up!"
  ),
  Badge(
    name: "now-u top dog",
    image: "assets/imgs/badges/achievement badges-09.png",
    points: 1500,
    successMessage: "Look at us go! Each small win will culminate into bigger victories down the line! "
  ),
  Badge(
    name: "now-u leader",
    image: "assets/imgs/badges/achievement badges-10.png",
    points: 2000,
    successMessage: "Really impressive! Just look back at the progress you have made! Keep it up!"
  ),
  Badge(
    name: "now-u expert",
    image: "assets/imgs/badges/achievement badges-11.png",
    points: 2500,
    successMessage: "Nicely done! Persistence and perseverance really does pay off!"
  ),
  Badge(
    name: "now-u master",
    image: "assets/imgs/badges/achievement badges-12.png",
    points: 3000,
    successMessage: "Incredible! You stepped up to the role and have played a huge part in driving positive change! Bravo!"
  ),
];
