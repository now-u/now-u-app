...
class SelectionPill extends StatelessWidget {
  ...
  SelectionPill(this.text, this.selected, 
    {
      this.borderRadius,
      this.fontSize,
    });
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      child: Container(
        ...
        child: Center(
          child: Padding(
            padding: EdgeInsets.symmetric(horizontal: fontSize ?? 20 / 2, vertical: fontSize ?? 20 / 4),
            child: Text(
              text,
              style: textStyleFrom(
                Theme.of(context).primaryTextTheme.bodyText1,
                fontWeight: selected ? FontWeight.w800 : FontWeight.w500,
                color: selected ? Theme.of(context).primaryColor : Color.fromRGBO(55,58,74,1),
