...
class CustomIcons {
  ...
  static const IconData ic_news = IconData(0xe813, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_more = IconData(0xe814, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  ...
  static const IconData ic_raiseawareness = IconData(0xe822, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_messenger = IconData(0xe823, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_faq = IconData(0xe824, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_suggestcamp = IconData(0xe825, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_feedback = IconData(0xe826, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_rateus = IconData(0xe827, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_dev = IconData(0xe828, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_email = IconData(0xe829, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_social_insta = IconData(0xe82a, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_social_twitter = IconData(0xe82b, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_social_fb = IconData(0xe82c, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_radio_off = IconData(0xe82d, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_radio_on = IconData(0xe82e, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_box_on = IconData(0xe82f, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_box_off = IconData(0xe830, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_toggle_on = IconData(0xe831, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_toggle_off = IconData(0xe832, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_play = IconData(0xe833, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_check = IconData(0xe834, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_question = IconData(0xe835, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_join = IconData(0xe836, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_time = IconData(0xe837, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_close = IconData(0xe838, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData ic_failure = IconData(0xe839, fontFamily: _kFontFam, fontPackage: _kFontPkg);
