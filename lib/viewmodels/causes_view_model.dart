...
class CausesViewModel extends BaseModel {
  ...
  Future fetchCauses() async {
    ...
    _causesList = [
      Cause(title: 'Environment'),
      Cause(title: 'Health & Wellbeing'),
      Cause(title: 'Equality & Human-Rights'),
      Cause(title: 'Education & Citizenship'),
      Cause(title: 'Economic Opportunity'),
      Cause(title: 'Safe Homes & Community')
    ];
    notifyListeners();
  }
