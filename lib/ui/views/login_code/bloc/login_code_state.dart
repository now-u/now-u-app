...
sealed class LoginCodeSubmissionState with _$LoginCodeSubmissionState {
  const factory LoginCodeSubmissionState.initial() = LoginCodeSubmissionStateInitial;
  const factory LoginCodeSubmissionState.inProgress() = LoginCodeSubmissionStateInProgress;
  const factory LoginCodeSubmissionState.failure() = LoginCodeSubmissionStateFailure;
...
class LoginCodeState with _$LoginCodeState {
  factory LoginCodeState({
    @Default(LoginCodeSubmissionState.initial()) LoginCodeSubmissionState status,
