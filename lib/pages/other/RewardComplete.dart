...
class RewardCompletePage extends StatelessWidget {
  ...
  RewardCompletePage(this.completedRewards);
              ...
              itemBuilder: (BuildContext context, int index) {
                if (index == 0) {
                  return Container(
                    ...
                    child: Image(
                      image: AssetImage('assets/imgs/partyPopperEmoji.png'),
                    ),
                  );
                }
                if (index == 1) {
                  return Padding(
                    ...
                    child: Text(
                      length != 1
                          ? "You just completed ${length} achievements!"
                          : "You completed an achievement",
          ...
          Padding(
            ...
            child: DarkButton(
              ...
              onPressed: () {
                ...
                Share.share(
                    'I just completed the ${campaingText} on now-U. Check them out at https://now-u.com');
              },
            ),
          ),
          Padding(
