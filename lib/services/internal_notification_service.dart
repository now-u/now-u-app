...
class InternalNotificationService {
  ...
  Future fetchNotifications() async {
    try {
      _notifications = await _apiService.getModelListRequest("v1/users/me/notifications", InternalNotification.fromJson);
    } catch (e) {
  ...
  Future<bool> dismissNotification(int? notificationId) async {
    try {
      await _apiService.putRequest("v1/users/me/notifications/$notificationId/dismiss");
